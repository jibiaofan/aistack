...
def render_benchmark_method_intro() -> list[str]:
    return [
        ...
        "",
        "AIStack's benchmark implementation is built on top of [guidellm](https://github.com/vllm-project/guidellm) via the wrapper project [benchmark-runner](https://github.com/gpustack/benchmark-runner).",
        "",
