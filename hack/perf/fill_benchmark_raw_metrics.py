...
Examples:
  python3 hack/perf/fill_benchmark_raw_metrics.py \
    --dir $RESULTS_DIR \
    --gpustack-url $AISTACK_URL \
    --gpustack-token $AISTACK_TOKEN
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gpustack-url", required=True, help="AIStack base URL.")
    parser.add_argument(
        "--gpustack-token", required=True, help="AIStack API token for authentication."
    )
    parser.add_argument(
        "--force",
        action="store_true",
