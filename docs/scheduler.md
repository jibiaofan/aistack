...
- **GGUF models:** resource requirements are estimated with the [GGUF parser](https://github.com/aistack/gguf-parser-go).
...
- **GGUF, custom backends, VoxBox:** Uses the [GGUF parser](https://github.com/aistack/gguf-parser-go) to estimate the model's resource requirements.Support GPU offload, partial offload or CPU execution.
