...
| `--system-default-container-registry` value | `docker.io`                            | Default container registry for AIStack to pull system and inference images.                                                          |
| `--image-name-override` value               | (empty)                                | Override the default image name for the AIStack container.                                                                           |
| `--image-repo` value                        | `aistack/aistack`                    | Override the default image repository for the AIStack container.                                                                     |
...
| `--benchmark-image-repo` value           | `aistack/benchmark-runner`            | Override the default benchmark image repo for the AIStack benchmark container.                                                                                                              |
