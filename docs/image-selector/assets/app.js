...
function bindEvents() {
    ...
    elements.aistackVersionSelect.addEventListener('change', (e) => selectGpuStackVersion(e.target.value));
...
function getCurrentImages(component) {
    const imgs = [];
    if (state.selectedGpuStackVersion) imgs.push(getFullImageName('aistack', state.selectedGpuStackVersion, state.selectedRegistry));
...
function generateImageList() {
    ...
    if (state.selectedGpuStackVersion) {
        ...
        cmds.push(`docker pull${plat} ${getFullImageName('aistack', state.selectedGpuStackVersion, state.selectedRegistry)}`);
    }
