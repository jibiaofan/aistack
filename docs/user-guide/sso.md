...
sudo docker run -d --name aistack \
    ...
    -e GPUSTACK_SAML_SP_ENTITY_ID="urn:aistack:sp" \
    -e GPUSTACK_SAML_SP_ACS_URL="<your-aistack-server-url>/auth/saml/callback" \
    ...
    -e GPUSTACK_SAML_SP_SLO_URL="<your-aistack-server-url>/auth/saml/logout/callback" \
...
sudo docker run -d --name aistack \
    ...
    --volume aistack-data:/var/lib/aistack \
    --runtime nvidia \
    -e GPUSTACK_SERVER_EXTERNAL_URL="https://aistack.example.com" \
