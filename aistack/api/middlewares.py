...
from aistack.api.exceptions import ErrorResponse
from aistack.routes.rerank import RerankResponse, RerankUsage
from aistack.schemas.images import ImageGenerationChunk, ImagesResponse
from aistack.schemas.model_usage import OperationEnum
...
from aistack.api.types.openai_ext import CreateEmbeddingResponseExt, CompletionExt
...
async def _resolve_direct_consumer_org(
    ...
    """
    from aistack.api.tenant import resolve_tenant_context
