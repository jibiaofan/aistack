...
def start_cmd_options(parser_server: argparse.ArgumentParser):
    ...
    common_group.add_argument(
        ...
        type=str,
        help="Default container registry for AIStack to pull system and inference images. The default is 'docker.io'.",
    ...
    common_group.add_argument(
        "--image-repo",
        type=str,
        help="Override the default image repository aistack/aistack for the AIStack container.",
        default=get_aistack_env("IMAGE_REPO"),
    )
    common_group.add_argument(
        "--benchmark-image-repo",
        type=str,
        help="Override the default benchmark image repository aistack/benchmark-runner for the AIStack benchmark container.",
