...
def upgrade() -> None:
    ...
    sa.Column('expires_at', aistack.schemas.common.UTCDateTime(), nullable=True),
    ...
    sa.Column('system_reserved', aistack.schemas.common.JSON(), nullable=True),
...
def write_bootstrap_version():
    ...
    aistack_config = aistack.config.config.get_global_config()
    data_dir = aistack_config.data_dir if aistack_config else "/var/lib/aistack"
