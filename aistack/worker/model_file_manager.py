...
from aistack.utils import hub
from aistack.utils.file import delete_path, get_local_file_size_in_byte
from aistack.worker import downloaders
from aistack.config.registration import read_worker_token
from aistack.utils.locks import read_lock_info, get_lock_path
...
class ModelFileDownloadTask:
    ...
    def _handle_tqdm_init(self, tqdm_instance, original_init, *args, **kwargs):
        ...
        tqdm_instance._aistack_id = tqdm_id
    ...
    def _handle_tqdm_update(self, tqdm_instance, original_update, n=1):
        ...
        tqdm_id = getattr(tqdm_instance, '_aistack_id', None)
    ...
    def _get_cache_file_actual_size(self, tqdm_instance) -> int | None:
        try:
            ...
            tid = getattr(tqdm_instance, '_aistack_id', None)
            if tid is not None:
