...
from aistack.schemas.config import PredefinedConfigNoDefaults
...
from aistack.utils.uuid import (
    set_worker_name,
    get_worker_name,
    set_legacy_uuid,
    get_legacy_uuid,
)
from aistack.utils.version import is_worker_version_compatible
...
class WorkerManager:
    ...
    def _ensure_builtin_labels(self) -> dict:
        ...
        if (is_legacy_token or is_legacy_worker) and is_existing_worker:
            labels["aistack.existence-check"] = "true"
        return labels
