...
foundation migration; see :mod:`aistack.schemas.user_passwords` for
...
from aistack.schemas.user_passwords import (
    PasswordAlgorithm,
    UserPassword,
)
from aistack.security import get_secret_hash, verify_hashed_secret
