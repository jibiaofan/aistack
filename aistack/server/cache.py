...
from aistack.server.coordinator.base import Event, EventType

if TYPE_CHECKING:
    from aistack.server.coordinator.base import Coordinator
...
def class_key(suffix: str):
    ...
    # Using kwargs as key causes https://github.com/aistack/aistack/issues/4813.
