...
from aistack.schemas.common import ItemList
from aistack.schemas.dashboard import (
    CurrentSystemLoad,
    HistorySystemLoad,
    ModelSummary,
    ModelUsageStats,
...
from aistack.schemas import Worker, Cluster
from aistack.schemas.model_provider import ModelProvider
from aistack.server.system_load import compute_system_load
...
async def _get_aistack_active_models(
    session: AsyncSession,
    cluster_id: Optional[int] = None,
    owner_principal_id: Optional[int] = None,
) -> List[ModelSummary]:
...
async def get_active_models(
    ...
    summary = await _get_aistack_active_models(session, cluster_id, owner_principal_id)
