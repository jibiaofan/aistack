...
from aistack.gateway import ext_auth_plugin
...
class TestExtAuthPlugin:
    def _build(self, namespace, gateway_namespace):
        ...
        with (
            patch(
                "aistack.gateway.get_gpustack_higress_registry", return_value=registry
            ),
            patch(
                "aistack.gateway.get_plugin_url_with_name_and_version",
