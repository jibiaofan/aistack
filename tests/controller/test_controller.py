...
from aistack.server.controllers import find_scale_down_candidates
...
async def test_find_scale_down_candidates():
    ...
    with (
        patch(
            'aistack.schemas.models.ModelInstance.all_by_field',
            return_value=mis,
        ),
        patch(
            'aistack.schemas.models.ModelInstance.all',
            return_value=mis,
        ),
        patch(
