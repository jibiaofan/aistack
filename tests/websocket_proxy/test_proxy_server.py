...
from aistack.websocket_proxy.message_server import MessageServerHandler, router
...
class TestHTTPProxy:
    ...
    async def test_http_proxy_with_content_length(self):
        ...
        def direct_connection_manager_getter(_target_ip: str):
            from aistack.websocket_proxy.connection_manager import ConnectionManager
