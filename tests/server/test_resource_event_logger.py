...
import aistack.server.resource_event_logger as rel
from aistack.server.bus import EventType
from aistack.server.resource_event_logger import (
    ResourceEventLogger,
    _resolve_principals,
)
...
def _patch_services(principals: dict, clusters: dict):
    ...
    with (
        patch("aistack.server.resource_event_logger.ClusterService") as CS,
        patch("aistack.server.resource_event_logger.PrincipalService") as PS,
    ):
