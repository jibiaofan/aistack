...
from aistack.server.controllers import WorkerController
...
async def test_worker_controller_marks_distributed_subordinate_unreachable_when_worker_unreachable():
    ...
    with (
        patch(
            "aistack.server.controllers.async_session",
        ...
        patch(
            "aistack.server.controllers.ModelInstanceService.update",
            update,
        ),
    ):
...
async def test_worker_controller_deletes_distributed_instance_when_subordinate_worker_deleted():
    ...
    with (
        ...
        patch(
            "aistack.server.controllers.ModelInstanceService.batch_delete",
            batch_delete,
        ),
    ):
        controller = WorkerController(MagicMock())
