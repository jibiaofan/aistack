...
from aistack import ssl_context
from aistack.ssl_context import make_ssl_context, resolve_ca_bundle
...
def test_resolve_ca_bundle_falls_back_when_env_file_missing(
    ...
    try:
        with mock.patch.object(
            ...
            with caplog.at_level("WARNING", logger="aistack.ssl_context"):
