...
from aistack.policies.scorers.placement_scorer import (
    PlacementScorer,
    ScaleTypeEnum,
)
...
async def test_candidate_score_chain_spread_locality():
    ...
    with (
        ...
        patch(
            "aistack.server.services.ModelFileService.get_by_source_index",
            new=AsyncMock(return_value=[_mock_model_file(worker2.id)]),
        ),
        patch(
            "aistack.server.services.ModelFileService.get_by_resolved_path",
...
async def test_candidate_score_chain_binpack_and_locality():
    ...
    with (
        patch(
            "aistack.policies.scorers.placement_scorer.get_worker_allocatable_resource",
...
async def test_instance_score_chain_with_real_scorers():
    ...
    with (
        patch(
            "aistack.policies.scorers.status_scorer.async_session",
            return_value=mock_async_session,
        ),
        patch(
            "aistack.policies.scorers.placement_scorer.get_worker_allocatable_resource",
        ...
        patch(
            "aistack.policies.scorers.status_scorer.Worker.all",
            new=AsyncMock(return_value=[worker1, worker2]),
        ),
        patch(
            "aistack.policies.scorers.placement_scorer.Worker.all",
            new=AsyncMock(return_value=[worker1, worker2]),
        ),
    ):
