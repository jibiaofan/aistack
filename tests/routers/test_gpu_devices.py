...
from aistack.policies.base import Allocated
from aistack.routes.gpu_devices import (
    _inject_allocated_into_event,
    to_gpu_device_public,
)
from aistack.schemas.gpu_devices import GPUDevice, GPUDevicePublic
from aistack.server.bus import Event, EventType
from aistack.server.worker_allocated_cache import vram_allocated_for_index
...
def _patched_allocated(vram):
    ...
    return patch(
        "aistack.routes.gpu_devices.get_worker_allocated",
