...
from aistack.routes.workers import (
    delete_worker,
...
def _patch_worker_one_by_id(worker):
    ...
    return patch(
        "aistack.routes.workers.Worker.one_by_id",
...
async def test_delete_worker_allowed_for_org_admin_in_owning_org():
    ...
    with (
        ...
        patch("aistack.routes.workers.WorkerService") as service_cls,
    ):
...
def test_worker_visibility_filter_scopes_cluster_bound_system():
    ...
    from aistack.routes.workers import _make_worker_visibility_filter
    from aistack.schemas.principals import PrincipalType
