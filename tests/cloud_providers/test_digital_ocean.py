import pytest
from aistack.cloud_providers.digital_ocean import DigitalOceanClient
from aistack.cloud_providers.abstract import CloudInstanceCreate, InstanceState
from aistack.cloud_providers.abstract import Volume
...
def do_client(monkeypatch):
    monkeypatch.setattr('aistack.cloud_providers.digital_ocean.Client', DummyClient)
